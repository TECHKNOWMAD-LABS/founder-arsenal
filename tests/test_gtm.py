...
class TestCalculateUnitEconomics:
    ...
    def test_excellent_economics(self):
        result = calculate_unit_economics(
            cac=1000, monthly_revenue_per_customer=500,
            gross_margin_pct=80, avg_customer_lifetime_months=24
        )
    ...
    def test_poor_economics(self):
        result = calculate_unit_economics(
            cac=10000, monthly_revenue_per_customer=100,
            gross_margin_pct=50, avg_customer_lifetime_months=12
        )
    ...
    def test_ltv_formula(self):
        ...
        result = calculate_unit_economics(
            cac=500, monthly_revenue_per_customer=100,
            gross_margin_pct=70, avg_customer_lifetime_months=24
        )
    ...
    def test_payback_formula(self):
        ...
        result = calculate_unit_economics(
            cac=1000, monthly_revenue_per_customer=200,
            gross_margin_pct=75, avg_customer_lifetime_months=36
        )
    ...
    def test_ltv_cac_ratio_formula(self):
        result = calculate_unit_economics(
            cac=500, monthly_revenue_per_customer=100,
            gross_margin_pct=80, avg_customer_lifetime_months=12
        )
    ...
    def test_recommendations_not_empty(self):
        result = calculate_unit_economics(
            cac=1000, monthly_revenue_per_customer=100,
            gross_margin_pct=60, avg_customer_lifetime_months=18
        )
        assert len(result.recommendations) > 0
